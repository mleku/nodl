...
func (ws *WS) Challenge() (challenge S) { return ws.challenge.Load() }
...
func (ws *WS) AuthPubKey() (a S) { return ws.authPubKey.Load() }
func (ws *WS) SetAuthPubKey(a S) { ws.authPubKey.Store(a) }
