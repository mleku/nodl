...
func Main(osArgs []string, c context.T, cancel context.F) {
	...
	rl.StoreEvents = append(rl.StoreEvents, rl.Chat)
	rl.StoreEvents = append(rl.StoreEvents, db.SaveEvent)
	rl.QueryEvents = append(rl.QueryEvents, db.QueryEvents)
	rl.CountEvents = append(rl.CountEvents, db.CountEvents)
	rl.DeleteEvents = append(rl.DeleteEvents, db.DeleteEvent)
	rl.OnConnects = append(rl.OnConnects, rl.AuthCheck)
	rl.RejectReqFilters = append(rl.RejectReqFilters, app.NoSearchQueries)
	rl.RejectReqFilters = append(rl.RejectReqFilters, app.NoComplexFilters)
	rl.RejectReqFilters = append(rl.RejectReqFilters, app.NoEmptyFilters)
	rl.RejectReqFilters = append(rl.RejectReqFilters, rl.FilterPrivileged)
	rl.RejectCountFilters = append(rl.RejectCountFilters, rl.FilterPrivileged)
	rl.OverrideDeletions = append(rl.OverrideDeletions, rl.OverrideDelete)
