...
var listeners = xsync.NewTypedMapOf[*relayws.WS, ListenerMap](PointerHasher[relayws.WS])
...
func GetListeningFilters() (respFilters *filters.T) {
	...
	listeners.Range(func(_ *relayws.WS, subs ListenerMap) bool {
...
func SetListener(id string, ws *relayws.WS, f filters.T, c context.C) {
...
func RemoveListenerId(ws *relayws.WS, id *subscriptionid.T) {
...
func RemoveListener(ws *relayws.WS) { listeners.Delete(ws) }
